      ...
      >
        <div className="glass-panel border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-accent-cyan/20 to-accent-purple/20 mb-4 shadow-[0_0_30px_rgba(0,229,255,0.15)]">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-white text-black font-semibold text-sm hover:bg-gray-100 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-[#24292e] text-white font-semibold text-sm hover:bg-[#2f363d] transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg border border-white/10"
            >
